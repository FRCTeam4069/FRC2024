...
public class FieldConstants {
    ...
    public static final Pose2d poseRedSpeaker = new Pose2d(new Translation2d(16.51, 5.547867999999999), new Rotation2d(Units.degreesToRadians(0))); //x equals total field length minus abs value of red x, y equals total field width minus blue y
