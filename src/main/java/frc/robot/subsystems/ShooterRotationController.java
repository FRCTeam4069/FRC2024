...
public class ShooterRotationController extends SubsystemBase {
    ...
    public ShooterRotationController(){
        left = new CANSparkMax(DeviceIDs.SHOOTER_ARTICULATE_LEFT, MotorType.kBrushless);
        right = new CANSparkMax(DeviceIDs.SHOOTER_ARTICULATE_RIGHT, MotorType.kBrushless);
