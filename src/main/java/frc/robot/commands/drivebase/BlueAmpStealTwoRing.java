...
public class BlueAmpStealTwoRing extends SequentialCommandGroup {
    private SwerveDrivetrain drive;
    private IntakeController intake;
    private IndexerController indexer;
    private ShooterController shooter;
    private ShooterRotationController rotShoot;
    public BlueAmpStealTwoRing(SwerveDrivetrain drive, IntakeController i, IndexerController index, ShooterController shooter, ShooterRotationController rot) {
        this.drive = drive;
        intake = i;
        indexer = index;
        ...
        addCommands(
            new SequentialCommandGroup(
                ...
                new ParallelCommandGroup(
                    new SequentialCommandGroup(
                        new FollowPath(drive, "blue amp steal further p4", new PIDConstants(2.9), 0.1),
                        new FollowPath(drive, "blue amp steal further p5", new PIDConstants(2.9), new PIDConstants(3.0), 0.1),
                        new InstantCommand(() -> drive.stopModules())
                        // new InstantCommand(() -> index.setCustomSpeed(0.90))
