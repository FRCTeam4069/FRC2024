...
public class testAutov5 extends SequentialCommandGroup {
    private SwerveDrivetrain drive;
    private IntakeController intake;
    private IndexerController indexer;
    private ShooterController shooter;
    private ShooterRotationController rotShoot;
    public testAutov5(SwerveDrivetrain drive, IntakeController i, IndexerController index, ShooterController shooter, ShooterRotationController rot) {
        this.drive = drive;
        intake = i;
        indexer = index;
        ...
        addCommands(
            new SequentialCommandGroup(
                ...
                //new InstantCommand(() -> drive.setPose(new Pose2d(0.0, 0.0, Rotation2d.fromDegrees(0.0)))),
                new BadPIDCommand(drive, new Pose2d(1.47, 1.47, Rotation2d.fromDegrees(-25.0))),
                ...
                new ParallelCommandGroup(
                    ...
                    new SequentialCommandGroup(
                        new BadPIDCommand(drive, new Pose2d(-0.5, 1.64, Rotation2d.fromDegrees(drive.getDegrees()))),
                        new BadPIDCommand(drive, new Pose2d(0.3, 1.64, Rotation2d.fromDegrees(drive.getDegrees())))
