...
public class RedSourceDumpAndDash extends SequentialCommandGroup {
    private SwerveDrivetrain drive;
    private IntakeController intake;
    private IndexerController indexer;
    private ShooterController shooter;
    private ShooterRotationController rotShoot;
    public RedSourceDumpAndDash(SwerveDrivetrain drive, IntakeController i, IndexerController index, ShooterController shooter, ShooterRotationController rot) {
        this.drive = drive;
        intake = i;
        indexer = index;
        ...
        addCommands(
            new SequentialCommandGroup(
                new InstantCommand(() -> drive.setPose(new Pose2d(0.73, 6.62, Rotation2d.fromDegrees(60.0)))),
                new InstantCommand(() -> drive.setPose(new Pose2d(0.73, 6.62, Rotation2d.fromDegrees(60.0)))),
                ...
                new BadPIDCommand(drive, new Pose2d(1.90, 9.00, Rotation2d.fromDegrees(0.0)), 0.02, 2.0),
                new InstantCommand(() -> drive.setPose(new Pose2d(drive.getPose().getTranslation(), Rotation2d.fromDegrees(0.0)))),
                new InstantCommand(() -> drive.setPose(new Pose2d(drive.getPose().getTranslation(), Rotation2d.fromDegrees(0.0)))),
                new FollowPath(drive, "red source dump and dash", new PIDConstants(3.0), 0.0),
