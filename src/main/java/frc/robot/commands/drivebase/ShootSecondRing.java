...
@Deprecated
public class ShootSecondRing extends SequentialCommandGroup {
    public ShootSecondRing(SwerveDrivetrain drive, IntakeController i, IndexerController index, ShooterController shooter, ShooterRotationController rot) {
