...
public class TwoNoteNew extends SequentialCommandGroup {
    private SwerveDrivetrain drive;
    private IntakeController intake;
    private IndexerController indexer;
    private ShooterController shooter;
    private ShooterRotationController rotShoot;
    public TwoNoteNew(SwerveDrivetrain drive, IntakeController i, IndexerController index, ShooterController shooter, ShooterRotationController rot) {
        this.drive = drive;
        intake = i;
        indexer = index;
        ...
        addCommands(
            new SequentialCommandGroup(
                ...
                new InstantCommand(() -> drive.setPose(new Pose2d(0.7, 4.45, Rotation2d.fromDegrees(330.0)))),
                ...
                new BadPIDCommand(drive, new Pose2d(2.4, 4.45, Rotation2d.fromDegrees(330.0))),
