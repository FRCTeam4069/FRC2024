...
public class RedAmpSteal extends SequentialCommandGroup {
    private SwerveDrivetrain drive;
    private IntakeController intake;
    private IndexerController indexer;
    private ShooterController shooter;
    private ShooterRotationController rotShoot;
    public RedAmpSteal(SwerveDrivetrain drive, IntakeController i, IndexerController index, ShooterController shooter, ShooterRotationController rot) {
        this.drive = drive;
        intake = i;
        indexer = index;
            ...
            new SequentialCommandGroup(
                ...
                new ParallelCommandGroup(
                    new SequentialCommandGroup(
                        ...
                        new FollowPath(drive, "red amp steal p5", new PIDConstants(2.9), new PIDConstants(3.0), 0.1),
                        new InstantCommand(() -> drive.stopModules())
                        // new InstantCommand(() -> index.setCustomSpeed(0.90))
                ...
                new SequentialCommandGroup(
                    new ParallelDeadlineGroup(
                        new SequentialCommandGroup(
                            new FollowPath(drive, "red amp steal p6", new PIDConstants(1.8), 0.1),
                            new FollowPath(drive, "red amp steal p7", new PIDConstants(1.1), 0.0),
                            new InstantCommand(() -> index.setCustomSpeed(0.90))
                        ),
                        new ParallelCommandGroup(
                            new SequentialCommandGroup(
                ...
                new SequentialCommandGroup(
                    new ParallelDeadlineGroup(
                        new SequentialCommandGroup(
                            new FollowPath(drive, "red amp steal p8", new PIDConstants(5.0), 0.0),
                            new InstantCommand(() -> index.setCustomSpeed(0.90))
                        ),
                        new ParallelCommandGroup(
                            new SequentialCommandGroup(
