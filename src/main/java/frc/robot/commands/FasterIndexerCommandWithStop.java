...
public class FasterIndexerCommandWithStop extends Command {
    private IndexerController indexer;
    private State state;
    private double setpoint;
    private PIDController pid;
    public FasterIndexerCommandWithStop(IndexerController indexer) {
    ...
    public boolean isFinished() {
        return (state == State.IN || state == State.PID) && Math.abs(indexer.getVelocity()) < 3.0;
    }
    @Override
